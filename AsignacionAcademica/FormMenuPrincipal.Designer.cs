namespace AsignacionAcademica
{
    partial class FormMenuPrincipal
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnAsignaturas = new Guna.UI2.WinForms.Guna2GradientButton();
            btnGrupos = new Guna.UI2.WinForms.Guna2GradientButton();
            ...
            btnProfesores.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnProfesores.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnProfesores.FillColor = Color.Empty;
            btnProfesores.FillColor2 = Color.Empty;
            btnProfesores.Font = new Font("Segoe UI", 9F);
            ...
            btnAulas.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnAulas.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnAulas.FillColor = Color.Empty;
            btnAulas.FillColor2 = Color.Empty;
            btnAulas.Font = new Font("Segoe UI", 9F);
            ...
            btnAsignaturas.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnAsignaturas.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnAsignaturas.FillColor = Color.Empty;
            btnAsignaturas.FillColor2 = Color.Empty;
            btnAsignaturas.Font = new Font("Segoe UI", 9F);
            ...
            btnGrupos.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnGrupos.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnGrupos.FillColor = Color.Empty;
            btnGrupos.FillColor2 = Color.Empty;
            btnGrupos.Font = new Font("Segoe UI", 9F);
            ...
            btnAsignarClases.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnAsignarClases.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnAsignarClases.FillColor = Color.Empty;
            btnAsignarClases.FillColor2 = Color.Empty;
            btnAsignarClases.Font = new Font("Segoe UI", 9F);
            btnAsignarClases.ForeColor = Color.White;
            ...
            btnConsultarAsignaciones.DisabledState.FillColor2 = Color.FromArgb(169, 169, 169);
            btnConsultarAsignaciones.DisabledState.ForeColor = Color.FromArgb(141, 141, 141);
            btnConsultarAsignaciones.FillColor = Color.Empty;
            btnConsultarAsignaciones.FillColor2 = Color.Empty;
            btnConsultarAsignaciones.Font = new Font("Segoe UI", 9F);
            btnConsultarAsignaciones.ForeColor = Color.White;
        ...
        private Guna.UI2.WinForms.Guna2GradientButton btnProfesores;
        private Guna.UI2.WinForms.Guna2GradientButton btnAulas;
        private Guna.UI2.WinForms.Guna2GradientButton btnAsignaturas;
        private Guna.UI2.WinForms.Guna2GradientButton btnGrupos;
